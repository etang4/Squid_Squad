...
public class FireballMaker : MonoBehaviour {
  ...
  void OnPinch(Vector3 pinch_position) {
    ...
    Debug.Log("Pinching");
    Instantiate(fireball, pinch_position, Quaternion.identity);
  ...
  void Update() {
    ...
    //Vector3 pinch_position = hand_model.fingers[3].GetTipPosition();
    ...
    if (grabbed_ != null) {
      ...
      //grabbed_.rigidbody.AddForce(transform.forward * forceSpringConstant);
